...
public class Double3 {
   ...
   /**
    * @return the string value of the Double3
    */
   ...
   public double get(int i) {
      ...
      throw new IllegalArgumentException("from get");
   }

   public double getX() {return d1;}
   public double getY() {return d2;}
   public double getZ() {return d3;}
}

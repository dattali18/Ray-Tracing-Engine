...
public class ShadowTests {
   ...
   void sphereTriangleHelper(String pictureName, Triangle triangle, Point spotLocation) {
      scene.geometries.add(sphere, triangle.setEmission(new Color(BLUE)).setMaterial(trMaterial));
      scene.lights.add( //
                       new SpotLight(new Color(400, 240, 0), spotLocation, new Vector(1, 1, -3)) //
                          .setKL(1E-5).setKQ(1.5E-7));
      camera.setImageWriter(new ImageWriter(pictureName, 400, 400)) //
         .renderImage() //
         .writeToImage();
   }
   ...
   /**
	...
	public void sphereTriangleMove1() {
		sphereTriangleHelper("shadowSphereTriangleMove2", //
				new Triangle(new Point(-70, -30, 0), new Point(-40, -60, 0), new Point(-68, -60, -4)), //
				new Point(-100, -100, 200));
	}
   ...
   /**
	...
	public void sphereTriangleMove2() {
		sphereTriangleHelper("shadowSphereTriangleMove1", //
		      new Triangle(new Point(-70, -35, 0), new Point(-40, -65, 0), new Point(-68, -64, -4)), //
				new Point(-100, -100, 200));
	}
   ...
   public void trianglesSphere() {
      ...
      scene.geometries.add( //
                           new Triangle(new Point(-150, -150, -115), new Point(150, -150, -135),
                                        new Point(75, 75, -150)).setEmission(new Color(30, 30, 30))
